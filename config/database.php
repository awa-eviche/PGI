...
'sigep' => [
    'driver' => 'mysql',
    'host' => env('SIGEP_DB_HOST', '127.0.0.1'),
    'port' => env('SIGEP_DB_PORT', '3306'),
    'database' => env('SIGEP_DB_DATABASE', 'sygep'),
    'username' => env('SIGEP_DB_USERNAME', 'root'),
    'password' => env('SIGEP_DB_PASSWORD', 'passer123'),
    'charset' => 'utf8mb4',
