<div>
    <div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            ...
            <a href="{{route('filiereetablissement.create')}}" class="px-3 rounded-md py-3 flex text-white text-xs font-bold text-center bg-orange-400 items-center">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            @foreach($filiereetablissements as $filiereetablissement)
            <div class="w-full h-auto bg-white">
    <!--img class="w-full h-auto" src="{{asset('assets/images/gray.jpg')}}" alt="Sunset in the mountains"-->
    <div class="px-3 py-4">
        <div class="font-bold text-xl mb-2 ">{{ $filiereetablissement->filiere->nom ?? '-' }}</div>
    ...
    <div class="px-3 py-2" >
        ...
        <div class="px-3 py-2"  >
        <a href="{{ route('filiereetablissement.show', $filiereetablissement->id) }}" class="mx-2 px-5 rounded-md py-4 flex text-white text-xs font-semibold text-center shadow-md bg-first-orange items-center justify-center " style="width:100px; position:relative;left:60%;">
