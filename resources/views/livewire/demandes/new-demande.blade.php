<div x-data="app({{ $livewireStep }})" x-init="init()" x-cloak class="rounded-sm bg-white shadow-xl py-3 mx-4 px-4 mb-5">
 ...
 <div class="mb-4">
 <x-label for="selectedRegion" class="font-semibold text-black">
 ...
 <option value="{{$region->id}}" wire:key="{{ $region['id'] }}">{{ $region['libelle'] }}</option>
 @endforeach
 </select>
 ...
 <div class="mb-4">
 <x-label for="selectedDepartemant" class="font-semibold text-black">
 ...
 <option value="{{$departement['id']}}" wire:key="{{ $departement['id'] }}">{{ $departement['libelle'] }}</option>
 @endforeach
 </select>
 @error('selectedDepartemant')
 <span class="text-xs text-red-500">
 {{$message}}
 </span>
 @enderror
 ...
 {{ isset($item['filiere']['nom']) ? htmlspecialchars($item['filiere']['nom']) : 'Nom de filière non disponible' }}
 </td>
 <td class="py-2 px-4 border-b w-1/2 border-l text-black">
 {{ isset($item['niveau']['nom']) ? htmlspecialchars($item['niveau']['nom']) : 'Nom de niveau non disponible' }}
 </td>
 </tr>
 @endforeach
 </tbody>
 ...
 <thead>
 <tr class="bg-gray-100">
 @if(isset($data['ancienne_adresse_etablissement']) || isset($data['nouvelle_adresse_etablissement']))
 ...
 @elseif(isset($data['ancienne_denomination_etablissement']) || isset($data['nouvelle_denomination_etablissement']))
 ...
 @elseif(isset($data['nom']) || isset($data['prenom']))
 ...
 <tr>
 @if(isset($data['ancienne_adresse_etablissement']) || isset($data['nouvelle_adresse_etablissement']))
 <td class="py-2 px-4 border-b w-1/2 border-l text-black">{{ htmlspecialchars($data['ancienne_adresse_etablissement']) }}</td>
 <td class="py-2 px-4 border-b w-1/2 border-l text-black">{{ htmlspecialchars($data['nouvelle_adresse_etablissement']) }}</td>
 @elseif(isset($data['ancienne_denomination_etablissement']) || isset($data['nouvelle_denomination_etablissement']))
 <td class="py-2 px-4 border-b w-1/2 border-l text-black">{{ htmlspecialchars($data['ancienne_denomination_etablissement']) }}</td>
 <td class="py-2 px-4 border-b w-1/2 border-l text-black">{{ htmlspecialchars($data['nouvelle_denomination_etablissement']) }}</td>
 @elseif(isset($data['nom']) || isset($data['prenom']))
 <td class="py-2 px-4 border-b w-1/2 border-l text-black">{{ htmlspecialchars($data['nom']) }}</td>
 <td class="py-2 px-4 border-b w-1/2 border-l text-black">{{ htmlspecialchars($data['prenom']) }}</td>
 @endif
 </tr>
 </tbody>
 </table>
