...
<div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            ...
            <a href="{{route('anneeacademique.create')}}" class="px-3 rounded-md py-3 flex text-white text-xs font-bold text-center bg-orange-400 items-center">
                ...
                <tbody class="bg-white divide-y ">
                    ...
                    @forelse ($anneeacademiques as $anneeacademique)
                        <tr class="text-gray-700 ">
                                    ...
                                    <td class="px-6 py-3 border-b">{{ $anneeacademique->code ?? ' - ' }}</td>
                                    <td class="px-6 py-3 border-b">{{ $anneeacademique->annee1 ?? ' - ' }}</td>
                                    <td class="px-6 py-3 border-b">{{ $anneeacademique->annee2 ?? ' - ' }}</td>
                                    <td class="px-6 py-3 border-b">{{ $anneeacademique->dateDebut ?? ' - ' }}</td>
                
                <td class="px-6 py-3 border-b">{{ $anneeacademique->dateFin?? '-' }}</td>

                <td class="px-6 py-3 border-b">{{ $anneeacademique->is_open == 1 ? "OUI" : "NON"}}</td>
                                    ...
                                    <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                        ...
                                        <div class="rounded-md ring-1 ring-black ring-opacity-5 bg-white">
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="{{ route('anneeacademique.show', $anneeacademique->id) }}"
                                                    class="text-purple-600">Voir
                                                </a>
                                            </div>
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="{{ route('anneeacademique.edit', $anneeacademique->id) }}" class="text-purple-600">
                                                    Modifier
                                                </a>
                                            </div>
                                            <div class="border shadow-md py-2 text-center">
                    ...
                    {!! Form::close() !!}
                                ...
                                {{--  <div
                                    ...
                                    <form class="text-center"
                                        action="{{ route('anneeacademique.destroy', $anneeacademiquee->id) }}" method="POST">
