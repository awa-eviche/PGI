<div>
    <div class="flex mb-5 justify-between">
        ...
        <div class="flex">
            ...
            <a href="{{route('entreprise.create')}}" class="px-3 rounded-md py-3 flex text-white text-sm text-center bg-first-orange">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                ...
                <tbody class="bg-white divide-y ">
                    @forelse ($entreprises as $entreprise)
                        <tr class="text-gray-700 ">
                            <td class="px-4 py-3 border-b">{{ $entreprise->nom_entreprise ?? ' - ' }}</td>
                            <td class="px-4 py-3 border-b text-maquette-gris">
                                {{ $entreprise->email_entreprise ?? ' - ' }}</td>
                            <td class="px-4 py-3 border-b">{{ $entreprise->ninea ?? '-' }}</td>
                            <td class="px-4 py-3 border-b text-maquette-gris">{{ $entreprise->effectif ?? '-' }}</td>
                                ...
                                <div class="relative" x-data="{ open: false }" @click.away="open = false"
                                    ...
                                    <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                        ...
                                        <div class="rounded-md ring-1 ring-black ring-opacity-5 bg-white">
                                            ...
                                            <div class="border shadow-md py-2 text-center">
                                                <a href="{{ route('entreprise.edit', $entreprise->id) }}" class="text-purple-600">
                                                    Modifier
                                                </a>
                                            </div>
                                            <div class="border shadow-md py-2 text-center">
                                                <form class="text-center"
                                                    action="{{ route('entreprise.destroy', $entreprise->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
