<div class="bg-transparent">
    ...
    <div class="flex mb-4 text-sm font-bold bg-white px-4 py-3 rounded-sm pl-4">
        ...
        <p> <a href="{{route('indicateur.index')}}">Survey </a>
        ...
        <div class="sm:w-1/3 w-full p-4">
            <div class="rounded-lg shadow-md p-4 bg-white2">
                <div class="flex justify-between items-center">
                    ...
                    <a wire:click="getRealisation('{{ $indicateur->id }}','{{ $indicateur->label }}')" href="#"
                ...
                <div class="mt-4">
                    ...
                    <div class="flex justify-between items-center mt-3">
                        @if (auth()->user()->hasRole(config('constants.roles.superadmin')))
                            ...
                            <button data-modal-target="delete-indicateur'{{ $indicateur->id }}'" data-modal-toggle="delete-indicateur'{{ $indicateur->id }}'" class=" items-center justify-center px-1 rounded-md py-1 border flex text-orange-600 text-sm text-center bg-white border-orange-600 hover:bg-orange-600 hover:text-white" type="button">
                                <i class="fa fa-trash"></i>
                            </button>
                            
                            <div id="delete-indicateur'{{ $indicateur->id }}'" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                <div class="relative p-4 w-full max-w-md max-h-full">
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        <button type="button" class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="delete-indicateur'{{ $indicateur->id }}'">
                                        ...
                                        <div class="p-4 md:p-5 text-center">
                                            ...
                                            <div class="flex justify-between">
                                                <form class="text-center" action="{{ route('indicateur.destroy', $indicateur->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button data-modal-hide="delete-indicateur'{{ $indicateur->id }}'" type="submit" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                                                        Oui
                                                    </button>
                                                </form>
                                                <button data-modal-hide="delete-indicateur'{{ $indicateur->id }}'" type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Non</button>
                                            </div>
                        ...
                        @if ((auth()->user()->personnel && auth()->user()->personnel->etablissement_id) && (\Carbon\Carbon::now()->lt($indicateur->date_echeance) ))
                                                ...
                                                <div class="p-5">
                                                    ...
                                                    <div class="grid md:grid-cols-2 md:gap-6 pt-2">
                                                        <div class="mb-4">
                                                            ...
                                                            <input value="{{ $indicateur->label }}" type="text"
                                                                class="border border-gray-300 p-2 w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm"
                                                        ...
                                                        <div class="mb-4">
                                                            <label for="date_echeance"class="block text-gray-700 text-sm font-bold mb-2">Date Echéance</label>
                                                                ...
                                                                <div class="relative max-w-sm">
                                                                    ...
                                                                    <input datepicker name="date_echeance" type="text" value="{{date('M/d/Y',
