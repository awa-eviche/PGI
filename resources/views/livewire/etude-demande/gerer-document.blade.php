            ...
            <div class="p-4">
                <div class="">
                    ...
                    <div class="mt-4 mb-2 flex">
                        ...
                        <div class="w-2/3">
                            <span class="text-maquette">{{ Auth::user()->prenom }}</span>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 mb-2 flex">
                        ...
                        <div class="w-2/3">
                            <span class="text-maquette">{{ Auth::user()->nom }}</span>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 mb-2 flex">
                        ...
                        <div class="w-2/3">
                            <span class="text-maquette">{{ Auth::user()->email }}</span>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 mb-2 flex">
                        ...
                        <div class="w-2/3">
                            <span class="text-maquette">{{  Auth::user()->telephone }}</span>
                        </div>
                    </div>
