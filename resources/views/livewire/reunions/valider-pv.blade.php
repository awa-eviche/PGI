            ...
            <div class="px-10 min-h-96 py-10">
                ...
                <div class="mb-4 mx-auto w-full">
                    ...
                    <div class="flex justify-end mt-10">
                        ...
                        <button wire:click="refuser" class="hover:bg-red-900 hover:shadow-xl flex items-center bg-red-700 text-white py-2 px-4 text-sm rounded mx-2" {{ $disabled ? 'disabled' : '' }}>
