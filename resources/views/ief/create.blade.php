<x-app-layout>
    ...
    <div class="mx-auto max-w-5xl shadow-xl rounded">
        ...
        <form action="{{ route('ief.store') }}" method="POST" class="bg-white border-x-2 rounded px-8 pt-6 pb-8 mb-4">
            @csrf
            <div class="border border-gray-200">
                ...
                <div class="flex flex-wrap w-full justify-evenly">
                    ...
                    <div class="flex-grow mb-4 mr-2">
                        ...
                        <x-input id="email" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " type="text" name="email" :value="old('email')" required autofocus autocomplete="email" />
                        @error('email')
                        <span class="text-xs text-red-500">
                            {{$message}}
                ...
                <div class="flex flex-wrap w-full justify-evenly">
                    ...
                    <div class="flex-grow mb-4 mr-2">
                        ...
                        <x-input id="adresse" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " type="text" name="adresse" :value="old('adresse')" required autofocus autocomplete="adresse" />
                        @error('adresse')
                        <span class="text-xs text-red-500">
                            {{$message}}
                ...
                <div class="flex-grow mb-4 mr-2">
                    ...
                    <div class="checkbox-columns" style="column-count: 4; column-gap: 20px;">
                        ...
                        <div class="form-check" style="margin-bottom: 10px;">
                            <input class="form-check-input" type="checkbox" id="commune{{$commune->id}}" name="communes[]" value="{{$commune->id}}">
