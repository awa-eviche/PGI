...
<div class="flex-grow mb-4 mr-2">
    ...
    <select id="classe_examen" name="classe_examen"
        ...
        <option value="0" @if($classe->classe_examen == 0) selected @endif>Non</option>
        <option value="1" @if($classe->classe_examen == 1) selected @endif>Oui</option>
    </select>
