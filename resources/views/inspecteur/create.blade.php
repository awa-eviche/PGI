    <x-app-layout>
        ...
        <form action="{{ route('inspecteur.store') }}" method="POST" class="bg-white border-x-2 rounded px-8 pt-6 pb-8 mb-4">
            @csrf
            <div class="border border-gray-200">
                ...
                <div class="flex flex-wrap w-full justify-evenly">
                    <div class="flex-grow mb-4 mr-2">
                        ...
                        <x-input id="specialite" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " type="text" name="specialite" :value="old('specialite')" required autofocus autocomplete="specialite" />
                        @error('specialite')
                        <span class="text-xs text-red-500">
                            {{$message}}
