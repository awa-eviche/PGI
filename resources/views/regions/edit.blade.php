<x-app-layout>
    ...
    <div class="rounded-sm w-full">
        <div class="w-full mx-auto max-w-6xl">
            ...
            <form class="bg-white shadow-md rounded pt-6 pb-8 mb-4" action="{{ route('region.update', $region->id) }}" method="POST">
                @csrf
                    ...
                    <div class="max-w-7xl sm:px-2 lg:px-4 ">
                            ...
                            <div class="flex flex-wrap w-full justify-evenly">
                                <div class="flex-grow mb-4 mr-2">
                                    ...
                                    <x-input id="code" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " type="text" name="code" value="{{ $region->code }}" required autofocus autocomplete="code" />
                                    @error('code')
                                ...
                                <div class="flex-grow mb-4 mr-2">
                                    ...
                                    <x-input id="libelle" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " type="text" name="libelle" value="{{ $region->libelle}}" required autofocus autocomplete="libelle" />
                                    @error('libelle')
                                        <span class="text-xs text-red-500">
                                            {{$message}}
