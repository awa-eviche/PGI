...
{{-- @dd(auth()->user()->personnel) --}}
    <div class="flex mb-4 text-sm font-bold p-3 bg-white">
        <p>
            <a href="{{route('document.category')}}" class="text-maquette">Accueil</a>
    ...
    <div class="rounded-sm w-full">
        ...
        <div class="mx-auto max-w-5xl shadow-xl rounded">
            <form action="{{ route('update.category', $categoryFile->id) }}" method="POST" class="bg-white border-x-2 rounded px-8 pt-6 pb-8 mb-4">
                @csrf
                @method('PUT')
                ...
                <div class="border border-gray-200 p-4">
                    <div class="flex flex-wrap w-full justify-evenly">
                        <div class="flex-grow  mb-4 mr-2">
                            ...
                            <x-input id="libelle" value="{{ $categoryFile->libelle }}" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " type="text" name="libelle" required autofocus autocomplete="libelle" />
                             @error('libelle')
                                ...
                                {{-- <ul class="items-center w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:flex dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                    <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                        <div class="flex items-center ps-3">
                                            <label for="Type1" class="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">DFPT</label>
                                        </div>
                                    </li>
                                    <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                        <div class="flex items-center ps-3">
                                            <input id="DFPTAjoter" type="checkbox" name="DFPT[]" value="Ajouter" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                            <label for="DFPTAjoter" class="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Ajouter</label>
                                        </div>
                                    </li>
                                    <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                        <div class="flex items-center ps-3">
                                            <input id="DFPTModifier" type="checkbox" name="DFPT[]" value="Modifier" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                            <label for="DFPTModifier" class="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Modifier</label>
                                        </div>
                                    </li>
                                    <li class="w-full dark:border-gray-600">
                                        <div class="flex items-center ps-3">
                                            <input id="DFPTSupprimer" type="checkbox" name="DFPT[]" value="Supprimer" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                                            <label for="DFPTSupprimer" class="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Supprimer</label>
                                        </div>
                                    </li>
                                </ul> --}}
