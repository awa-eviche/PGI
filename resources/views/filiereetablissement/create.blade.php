<x-app-layout>
    ...
    <div class="flex mb-4 text-sm font-bold p-3 bg-white">
        <p>
            <a href="{{route('filiereetablissement.index')}}" class="text-maquette">Accueil</a>
            <span class="mx-2 text-maquette">/</span>
            <a href="{{route('filiereetablissement.index')}}" class="text-maquette">Filière</a>
    ...
    <div class="rounded-sm w-full">
        ...
        <div class="mx-auto max-w-5xl shadow-xl rounded">
            <form action="{{ route('filiereetablissement.store') }}" method="POST" class="bg-white border-x-2 rounded px-8 pt-6 pb-8 mb-4">
                @csrf
