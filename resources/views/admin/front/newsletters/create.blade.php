...
{!! Form::model(new \App\Models\Newsletter(), ['route' => ['store.newsletters'], 'role' => 'form', 'class' => 'apix-form', 'files' => 'true']) !!}
    @php
        $pClass = " p-2.5";
            ...
            <div class="md:container md:mx-auto">
                ...
                <div class="grid md:grid-cols-1 md:gap-6 pt-4">
                    <div class="relative z-0 w-full mb-6 group">
                        ...
                        {!! Form::text('newsletter_object', null, ['id' => 'newsletter_object', 'class' => $inputClass.$pClass, 'required' => 'true', 'placeholder' => 'Objet de la newsletter']) !!}
                    </div>
                </div>
                <div class="grid md:grid-cols-1 md:gap-6 pt-2">
                    <div class="relative z-0 w-full mb-6 group">
                        ...
                        {!! Form::text('newsletter_content', null, ['id' => 'richEd', 'class' => $inputClass.$pClass, 'required' => 'true', 'placeholder' => '']) !!}
                    </div>
                </div>
                <div class="grid md:grid-cols-1 md:gap-6 pt-2">
                    <div class="relative z-0 w-full mb-6 group">
