<x-app-layout>
    ...
    <div class="flex mb-4 text-sm font-bold p-3 bg-white p-3 bg-white">
        <p>
            ...
            <span class="mx-2 text-maquette">/</span>
        <p> <a href="{{route('commune.index')}}">IA </a>
    ...
    <div class="mx-auto max-w-5xl shadow-xl rounded">
        ...
        <form action="{{ route('ia.store') }}" method="POST" class="bg-white border-x-2 rounded px-8 pt-6 pb-8 mb-4">
            @csrf
                ...
                <div class="flex-grow mb-4 mr-2">
                    ...
                    <div class="checkbox-columns" style="column-count: 4; column-gap: 20px;">
                        ...
                        <div class="form-check" style="margin-bottom: 10px;">
                            <input class="form-check-input" type="checkbox" id="departement_{{$departement->id}}" name="departements[]" value="{{$departement->id}}">
