<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Nouvelle année académique') }}
        </h2>
    </x-slot>

    <div class="flex mb-4 text-sm font-bold p-3 bg-white">
        <p>
            <a href="{{route('anneeacademique.index')}}"  class="text-maquette">Accueil</a>
              <span class="mx-2 text-maquette">/</span>
            <a href="{{route('anneeacademique.index')}}"  class="text-maquette">Référentiel</a>
              <span class="mx-2 text-maquette">/</span>
        <p> <a href="{{route('anneeacademique.index')}}" >Année académique  </a>
    ...
    <div class="rounded-sm w-full">
        ...
        <div class="mx-auto max-w-5xl shadow-xl rounded">
            <form action="{{ route('anneeacademique.store') }}" method="POST" class="bg-white border-x-2 rounded px-8 pt-6 pb-8 mb-4">
                @csrf
                ...
                <div class="border border-gray-200 p-4">
                    ...
                    <div class="flex-grow mb-4 mr-2">
                        ...
                        <x-input id="annee1" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " type="text" name="annee1" :value="old('annee1')" required autofocus autocomplete="annee1" />
                        @error('annee1')
                    ...
                    <div class="flex-grow mb-4 mr-2">
                        ...
                        <x-input id="annee2" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " type="text" name="annee2" :value="old('annee2')" required autofocus autocomplete="annee2" />
                        @error('annee2')
                            <span class="text-xs text-red-500">
                                {{$message}}
                ...
                <div class="flex flex-wrap w-full justify-evenly">
                    <div class="flex-grow mb-4 mr-2">
                        <x-label for="dateDebut">
                            Date de début <span class="text-red-500">*</span>
                        </x-label>
                        <x-input id="dateDebut" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " type="date" name="dateDebut" :value="old('dateDebut')" required autofocus autocomplete="dateDebut" />
                        @error('dateDebut')
                            <span class="text-xs text-red-500">
                                {{$message}}
                    ...
                    <div class="flex-grow mb-4 mr-2">
                        ...
                        <x-input id="dateFin" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " type="date" name="dateFin" :value="old('dateFin')" required autofocus autocomplete="dateFin" />
                        @error('dateFin')
                            <span class="text-xs text-red-500">
                                {{$message}}
