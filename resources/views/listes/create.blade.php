...
    </div>
    ...
    <div class="mx-auto max-w-5xl shadow-xl rounded" >
        <!-- <div class="w-full mx-auto max-w-2xl"> -->
            ...
            <form action="{{ route('liste.store') }}" method="POST" class="bg-white border-x-2 rounded px-8 pt-6 pb-8 mb-4">
                @csrf
                ...
                <div class="flex flex-wrap w-full justify-evenly">
                    ...
                    <div class="flex-grow mb-4 mr-2">
                        ...
                        <x-input id="valeur" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " type="text" name="valeur" :value="old('valeur')" required autofocus autocomplete="valeur" />
                        @error('valeur')
                            <span class="text-xs text-red-500">
                                {{$message}}
