                ...
                <tbody class="bg-white divide-y ">
                    ...
                    @forelse ($materiels as $materiel)
                        <tr class="text-gray-700 ">
                                    ...
                                    <td class="px-6 py-3 border-b">{{ $materiel->name ?? ' - ' }}</td> 
                            <td class="px-6 py-3 border-b"> {{ $materiel->serial_number ?? ' - ' }}</td>
                
                            <td class="px-6 py-3 border-b">{{ $materiel->type ?? ' - ' }}</td>
                            <td class="px-4 py-3 border-b">{{ $materiel->modele ?? ' - ' }}</td>
                            <td class="px-4 py-3 border-b">{{ $materiel->date_achat ?? ' - ' }}</td>
                            <td class="px-4 py-3 border-b">{{ $materiel->date_mise_en_service ?? ' - ' }}</td>
