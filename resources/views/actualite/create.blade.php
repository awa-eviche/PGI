...
@section('content')
    ...
    {!! Form::model(new \App\Models\Actualite(), ['route' => ['actualite.store'], 'role' => 'form', 'class' => 'apix-form', 'files' => 'true']) !!}
    @php
        $pClass = " p-2.5";
        $tclass = " p-2.5";
            ...
            <div class="md:container md:mx-auto">
                ...
                <div class="grid md:grid-cols-1 md:gap-6 pt-2">
                    <div class="relative z-0 w-full mb-6 group">
                        ...
                        {!! Form::text('title', null, ['id' => 'title', 'class' => $inputClass.$pClass, 'required' => 'true', 'placeholder' => 'Titre']) !!}
                    </div>
                </div>
                <div class="grid md:grid-cols-1 md:gap-6 pt-2">
                    <div class="relative z-0 w-full mb-6 group">
                        <label for="main_pic"
                            ...
                            principale</label>
                        {!! Form::file('image', ['id' => 'image', 'class' => $inputClass.$tclass,'required' => 'true' , 'placeholder'=>'Choisir une image']) !!}
                    </div>
                </div>
                <div class="grid md:grid-cols-1 md:gap-6 pt-2">
                    <div class="relative z-0 w-full mb-6 group">
                        ...
                        {!! Form::text('contenu', null, ['id' => 'richEd', 'class' => $inputClass.$pClass, 'required' => 'true', 'placeholder' => 'Titre']) !!}
                    </div>
                </div>
