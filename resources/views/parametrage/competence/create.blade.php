            ...
            <div class="border border-gray-200 p-4">
                ...
                <div class="flex flex-wrap w-full justify-evenly">
                    ...
                    <div class="flex-grow mb-4 mr-2">
                        ...
                        <x-input id="code" name="code" type="text"
                    ...
                    <div class="flex-grow mb-4 mr-2">
                        ...
                        <x-input id="nom" name="nom" type="text"
                    ...
                    <div class="flex-grow mb-4 mr-2">
                        ...
                        <x-select id="type" name="type" required
                            ...
                            <option value="generale" {{ old('type') == 'generale' ? 'selected' : '' }}>Générale</option>
                            <option value="particuliere" {{ old('type') == 'particuliere' ? 'selected' : '' }}>Particulière</option>
                        </x-select>
                        @error('type') <span class="text-xs text-red-500">{{ $message }}</span> @enderror
                    </div>
                </div>

                {{-- Composant Livewire (niveau, métier, etc.) --}}
