            ...
            <form action="{{ route('niveauetude.store') }}" method="POST" class="bg-white border-x-2 rounded px-8 pt-6 pb-8 mb-4">
                ...
                <div class="border border-gray-200 p-4">
                    ...
                    <div class="form-group">
                        ...
                        <x-input id="ann_id" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2 " type="number" name="annee" min="1" max="10" :value="old('annee')" autofocus autocomplete="annee" />
                    </div>
