<x-app-layout>
    ...
    <div class="rounded-sm w-full">
        <div class="mx-auto max-w-5xl shadow-xl rounded">
            <form action="{{ route('metier.store') }}" method="POST" class="bg-white border-x-2 rounded px-8 pt-6 pb-8 mb-4">
                @csrf
                ...
                <div class="border border-gray-200 p-4">
                    ...
                    <div class="flex flex-wrap w-full justify-evenly">
                        <div class="flex-grow mb-4 mr-2">
                            ...
                            <x-input id="code" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2"
                                     type="text" name="code" :value="old('code')" required autofocus autocomplete="code" />
                            @error('code')
                        ...
                        <div class="flex-grow mb-4 mr-2">
                            ...
                            <x-input id="nom" class="block w-full focus:border-first-orange enlever_shadow rounded px-2 py-0.75 shadow-first-orange text-sm border-2"
                    ...
                    <div class="mb-4 mx-auto w-full">
                        ...
                        <textarea id="description" name="description" rows="4" required
                                  ...
                                  class="shadow appearance-none border-2 border-gray-400 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline enlever_shadow">{{ old('description') }}</textarea>
                    </div>
