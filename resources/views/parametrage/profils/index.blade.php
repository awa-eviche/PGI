    ...
    <div class="container p-y rounded">
        <div class="flex justify-between items-center">
            ...
            <div class="flex justify-end mb-4">
                <a href="{{ route('profil.create') }}" class="flex items-center bg-first-orange hover:bg-cyan-700 text-white font-bold py-1 px-4 text-sm rounded">
            ...
            <div class="w-full overflow-x-scroll ">
                <table class="w-full border-t">
                    ...
                    <tbody class="bg-white divide-y">
                        @foreach($roles as $profil)
                            <tr class="text-gray-700">
                                <td class="px-4 py-3 border-b">{{ $profil->code }}</td>
                                <td class="px-4 py-3 border-b">{{ $profil->name }}</td>
                                <td class="px-4 py-3 border-b">{{ $profil->description }}</td>
                                ...
                                <td class="px-4 py-3 border-b">
                                    <div class="flex justify-center rounded items-center space-x-2 text-sm shadow-xl p-0.5 bg-gray-100">
                                        ...
                                        <a href="{{ route('profil.edit', $profil->id) }}" class="text-purple-600">
                                        ...
                                        <form class="text-center" action="{{ route('profil.destroy', $profil->id) }}" method="POST">
