<x-app-layout>
    ...
    <div class="flex mb-4 text-sm font-bold p-3 bg-white">
        <p>
            <a href="{{route("profil.index")}}"  class="text-maquette-gris">Liste des profil</a>
        </p>
   ...
   <div class="bg-white shadow rounded-sm w-full">
    <div class="w-full mx-auto max-w-2xl">
        <form action="{{ route('profil.store') }}" method="post" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            @csrf
            ...
            <div class="mb-4">
                ...
                <div class="flex items-center">
                    <label class="mr-4">
                        <input type="radio" name="est_actif" value="1" class="form-radio text-blue-600" {{ old('est_actif') == '1' ? 'checked' : '' }}>
                        <span class="ml-2">Actif</span>
                    </label>
                    <label>
                        <input type="radio" name="est_actif" value="0" class="form-radio text-red-600" {{ old('est_actif') == '0' ? 'checked' : '' }}>
