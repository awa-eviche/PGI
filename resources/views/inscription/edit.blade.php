<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __("Modification de l'inscrption") }}
        </h2>
    </x-slot>
    ...
    <div class="flex mb-4 text-sm font-bold p-3 bg-white">
        <p>
            <a href="{{route('inscription.index')}}" class="text-maquette">Accueil</a>
            <span class="mx-2 text-maquette">/</span>

        <p> <a href="{{route('inscription.index')}}">Classe </a>
    ...
    <div class="rounded-sm w-full p-4 mt-2">
        ...
        <div class="rounded-sm w-full">
            <div class="w-full mx-auto max-w-6xl">
                <form action="{{ route('inscription.update', $inscription->id) }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    @csrf
