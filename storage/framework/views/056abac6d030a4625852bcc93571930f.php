...
<!--[if BLOCK]><![endif]--><?php if(
    ...
    $user->hasRole('directeur_etude')
                                ...
                                <a class="text-white bg-green-600 text-sm rounded-md shadow-md px-4 py-2"
   target="_blank"
   href="<?php echo e(route('evaluation.classe.preview', ['id' => $currentClasse->id, 'semestre' => $selectedsemestre ?? 1])); ?>">
   <i class="fa fa-print"></i>&nbsp;Telecharger tous les bulletins (Semestre <?php echo e($selectedsemestre ?? 1); ?>)
</a>
...
<?php /**PATH /Applications/MAMP/htdocs/PGI-1/resources/views/livewire/inscription/liste-inscription.blade.php ENDPATH**/ ?>