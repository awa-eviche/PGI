...
<body>
    ...
    <nav class="navbar" id="navbar" aria-label="Navigation principale">
        <div class="nav-container">
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(url('/constructions')); ?>" class="nav-link">
                        <i class="fas fa-building mr-2"></i>Constructions
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo e(url('/insertion')); ?>" class="nav-link">
    ...
    <div class="mobile-menu" id="mobile-menu">
        <div class="mobile-nav">
            ...
            <div class="mobile-nav-item">
                <a href="<?php echo e(url('/constructions')); ?>" class="mobile-nav-link">
                    <i class="fas fa-building mr-3"></i>Constructions
                </a>
            </div>
            <div class="mobile-nav-item">
                <a href="<?php echo e(url('/insertion')); ?>" class="mobile-nav-link">
...
<?php /**PATH /Applications/MAMP/htdocs/PGI-1/resources/views/partials/head.blade.php ENDPATH**/ ?>