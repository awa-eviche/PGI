    ...
    public function render()
    {
        ...
        $allEtablissements = Etablissement::query('etablissements')
                                ...
                                ->Where(function($query) {
                                    ...
                                    if ($this->selectedIA) {
                                        $ias = Ia::find($this->selectedIA)->departements()->get();
                                        $communes = Commune::query()->whereIn('departement_id',Arr::pluck($ias, 'id'))->get();
                                        $query->WhereIn('etablissements.commune_id',Arr::pluck($communes,'id'));
                                    }
                                    if ($this->selectedIef) {
                                        $communes = Ief::find($this->selectedIef)->communes()->get();
                                        $query->WhereIn('etablissements.commune_id',Arr::pluck($communes,'id'));
                                    }
