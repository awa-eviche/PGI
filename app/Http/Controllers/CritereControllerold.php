...
class CritereController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(Critere::create(['libelle'=>request('libelle'),'element_competence_id'=>request('element'),'competence_id'=>request('competence_id'),'niveau_etude_id'=>request('niveau_etude_id')]))
        {
            return redirect()->route('critere.index')
                        ->withMessage('Critère enregistrée avec succès.');
        }
    ...
    public function update(Request $request, string $id)
    {
        ...
        if($critere->update(['libelle'=>request('libelle'),'element_competence_id'=>request('element'),'competence_id'=>request('competence_id'),'niveau_etude_id'=>request('niveau_etude_id')]))
        {
            return redirect()->route('critere.index')
